...
export default function SettingsLogistics({
    ...
    return (
        <div className="space-y-6">
                            ...
                            {(Array.isArray(config.deliveryZones) ? config.deliveryZones : []).map((zone, index) => (
                                <div key={index} className="flex items-center gap-3 bg-white/5 rounded-lg p-3">
                                    <input
                                        ...
                                        className="flex-1 bg-white/10 border border-[var(--color-border)] rounded-lg p-2 text-white text-sm placeholder:text-[var(--color-muted)]"
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-28 bg-white/10 border border-[var(--color-border)] rounded-lg p-2 pr-12 text-white text-sm"
                                            placeholder="1500"
                                        />
                            ...
                            <div className="flex items-center gap-3">
                                <div className="relative flex-1 max-w-xs">
                                    <input
                                        ...
                                        className="w-full bg-white/5 border border-[var(--color-border)] rounded-lg p-3 pr-16 text-white focus:border-orange-500 outline-none"
                                        placeholder="50000"
                                    />
                ...
                <div className="flex flex-wrap gap-3">
                    {[
                        ...
                        return (
                            <label
                                key={method.id}
                                className={`flex items-center gap-2 bg-white/5 border rounded-lg px-4 py-3 cursor-pointer select-none transition-all ${isChecked ? 'border-[#00D97E] shadow-[0_0_10px_rgba(99,102,241,0.2)]' : 'border-[var(--color-border)] hover:border-[var(--color-border)]'
                                    }`}
                            >
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-8 relative overflow-hidden">
                {/* Background Pattern */}
                ...
                <div className="relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <select
                                ...
                                className="w-full bg-white/5 border border-[var(--color-border)] rounded-lg p-3 text-white focus:border-emerald-500 outline-none appearance-none"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-white/5 border border-[var(--color-border)] rounded-lg p-3 text-white focus:border-emerald-500 outline-none font-mono tracking-wide placeholder:text-[var(--color-muted)]"
                    ...
                    {paystackSubaccountCode ? (
                        ...
                        <button
                            ...
                            className="w-full py-3 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-lg transition-all shadow-none shadow-emerald-900/20"
                        >
