    ...
    return (
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-5 md:p-8">
            ...
            <div className="space-y-4">
                {/* Negotiation Switch */}
                <div className="flex items-center justify-between bg-black border border-[var(--color-border)] p-4 rounded-xl">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-[var(--color-muted)]">Autoriser l&apos;IA à négocier les prix dans une limite raisonnable</div>
                        </div>
                    </div>
