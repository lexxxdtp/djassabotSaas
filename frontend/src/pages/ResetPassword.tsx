        ...
        <div className="auth-form-page min-h-screen bg-black flex items-center justify-center p-4">
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] p-8 rounded-[13px] w-full max-w-md shadow-none shadow-black/50">
                <div className="text-center mb-8">
                    ...
                    <h1 className="page-title text-2xl font-bold text-white mb-2 tracking-tight">Nouveau Mot de Passe</h1>
                    <p className="text-[var(--color-muted)] text-sm">Veuillez entrer votre nouveau mot de passe</p>
                </div>
                ...
                <form onSubmit={handleResetPassword} className="space-y-6">
                    <div>
                        <label className="block text-xs font-bold uppercase tracking-wider text-[var(--color-muted)] mb-2">Nouveau mot de passe</label>
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full bg-white/5 border border-[var(--color-border)] rounded-xl py-3 pl-10 pr-4 text-white placeholder-[#555] focus:outline-none focus:border-[#00D97E] focus:ring-1 focus:ring-[#00D97E] transition-all disabled:opacity-50"
                            />
                        </div>
                        <p className="text-xs text-[var(--color-muted)] mt-2">8 caractères min, 1 majuscule, 1 chiffre</p>
                    </div>

                    <div>
                        <label className="block text-xs font-bold uppercase tracking-wider text-[var(--color-muted)] mb-2">Confirmer le mot de passe</label>
                        <div className="relative group">
                            <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--color-muted)] group-focus-within:text-[#00D97E] transition-colors w-5 h-5" />
                            <input
                                type="password"
