    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in zoom-in duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-[#0D1117] border border-white/5 p-6 rounded-2xl flex items-center space-x-4 hover:border-[#00D97E]/20 transition-colors">
            ...
            <div className="flex space-x-6 border-b border-white/5 pb-1 overflow-x-auto">
                <button
                    ...
                    className={`pb-3 px-2 text-sm font-bold uppercase tracking-wide transition-all relative whitespace-nowrap ${activeTab === 'broadcast' ? 'text-[#00D97E]' : 'text-gray-500 hover:text-white'}`}
                >
                ...
                <button
                    ...
                    className={`pb-3 px-2 text-sm font-bold uppercase tracking-wide transition-all relative whitespace-nowrap ${activeTab === 'coupons' ? 'text-[#00D97E]' : 'text-gray-500 hover:text-white'}`}
                >
                    <div className="flex items-center space-x-2">
                        <Tag size={18} />
                ...
                <button
                    ...
                    className={`pb-3 px-2 text-sm font-bold uppercase tracking-wide transition-all relative whitespace-nowrap ${activeTab === 'abandoned' ? 'text-[#00D97E]' : 'text-gray-500 hover:text-white'}`}
                >
                    <div className="flex items-center space-x-2">
                        <TimerReset size={18} />
        ...
        <div className="bg-[#0D1117] border border-white/5 rounded-2xl p-6 space-y-6">
            ...
            <div>
                ...
                <textarea
                    ...
                    className="w-full bg-black border border-white/5 rounded-xl p-4 text-white focus:border-[#00D97E] outline-none resize-none placeholder:text-gray-600 transition-colors"
                />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select className="w-full bg-black border border-white/5 rounded-xl p-3 text-white focus:border-[#00D97E] outline-none">
                ...
                <div>
                    ...
                    <div className="relative group">
                        <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-[#00D97E] transition-colors" size={18} />
                        <input
                            type="datetime-local"
                            className="w-full bg-black border border-white/5 rounded-xl p-3 pl-10 text-white focus:border-[#00D97E] outline-none"
                        />
                    </div>
                </div>
            </div>

            <div className="p-8 bg-black/50 rounded-xl border border-dashed border-white/5 flex items-center justify-center text-gray-500 cursor-pointer hover:border-[#00D97E] hover:text-[#00D97E] transition-all group">
            ...
            <div className="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <input
                        ...
                        className="w-full bg-black border border-zinc-800 rounded-xl p-3 text-white focus:border-[#00D97E] outline-none uppercase font-mono placeholder:text-zinc-700"
                    />
                </div>
                <div>
                    ...
                    <div className="flex">
                        <input
                            type="number"
                            placeholder="10"
                            className="w-full bg-black border border-white/5 rounded-l-xl p-3 text-white focus:border-[#00D97E] outline-none placeholder:text-gray-600"
                        />
                        <select className="bg-[#0D1117] border border-white/5 rounded-r-xl px-3 text-white outline-none font-bold">
                            <option>%</option>
                            <option>FCFA</option>
                        </select>
                    </div>
            ...
            <div className="bg-black/50 border border-white/5 rounded-xl p-4">
                ...
                <div className="mt-4 pt-4 border-t border-white/5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" value="30" disabled className="bg-[#0D1117] text-gray-400 px-3 py-2 rounded-lg text-sm w-full border border-white/5" />
                    </div>
                    <div>
                        <label className="block text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-1">Message</label>
                        <input type="text" value="👋 Vous avez oublié quelque chose ?" disabled className="bg-[#0D1117] text-gray-400 px-3 py-2 rounded-lg text-sm w-full border border-white/5" />
                    </div>
                </div>
            </div>
